...
python check.py 32,64,128,256 "in 2D, FMKS coordinates" fmks
conv_2d mks coordinates/transform=mks
python check.py 32,64,128,256 "in 2D, MKS coordinates" mks
conv_2d linear_mc GRMHD/reconstruction=linear_mc
python check.py 32,64,128,256 "in 2D, linear recon with MC limiter" linear_mc
conv_2d linear_vl GRMHD/reconstruction=linear_vl
python check.py 32,64,128,256 "in 2D, linear recon with VL limiter" linear_vl
