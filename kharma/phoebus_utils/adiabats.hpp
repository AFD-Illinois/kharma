...
inline void GetRhoBounds(const EOS& eos, const Real rho_min, const Real rho_max,
    const Real T_min, const Real T_max, const Real Ye, const Real S0, Real& lrho_min_new,
    Real& lrho_max_new)
{
...
// sample log rho
inline void SampleRho(
    DataBox lrho, const Real lrho_min, const Real lrho_max, const int n_samps)
{
...
inline void ComputeAdiabats(DataBox lrho, DataBox temp, const EOS& eos, const Real Ye,
    const Real S0, const Real T_min, const Real T_max, const int n_samps)
{
 ...
 **/
template<typename EOS>
inline Real MinEnthalpy(
    DataBox lrho, DataBox temp, const Real Ye, const EOS& eos, const int n_samps)
{
