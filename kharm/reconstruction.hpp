/**
 * Reconstruction schemes.  Currently just WENO5, a.k.a. the best scheme.
 */

#include "decs.hpp"


KOKKOS_INLINE_FUNCTION void weno(const Real x1, const Real x2, const Real x3,
...
KOKKOS_INLINE_FUNCTION void weno(const Real x1, const Real x2, const Real x3, const Real x4, const Real x5,
                                Real &lout, Real &rout)
{
  // S11 1, 2, 3
  Real vr[3], vl[3];
